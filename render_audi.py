...
FOV_DEG = 35.0                  # perspective field of view (horizontal)
DISTANCE_K = 1.5                # camera distance = extent * DISTANCE_K (perspective)
...
plt.imsave("audi_render.png", np.clip(img, 0, 1))
print("rendered -> audi_render.png")
